...
To fully explain his concept and plan, although conditions didn't permit him to make a glass slide PPT, he specially produced an "Outline" and "Materials." The former was for the leader to grasp the main points; the latter was detailing, for the leader to read carefully if interested.
...
Feng Nuo paused for a moment to calm his nervous emotions, feeling his pitch was a bit high. He hadn't expected Yang Yun to really mention this punched card computer system, which hadn't even started, in the report, and actually fished up the big fish, the Governor. Feng Nuo knew too well the importance of a leader's visit to a cause. It wasn't just a matter of showing one's face before the leader; even if the leader listened without saying a word and left, it would have a very important promoting effect on the future of this project, same logic as asking a leader for an inscription when doing business in the past. This opportunity must be seized.

The project initiation seminar for the punched card computer bad been held once, basically determining the participants and rough plan. This meeting was mainly a discussion on the "punched card" itself. Because the punched card computer was different from the hand-cranked calculator, the data carrier—the specifications and various standards of the punched card—had to be determined first before mechanical design could proceed. The Senate had no physical object to imitate and could only reverse engineer based on information and the card itself. So, the first thing for the project was to determine the punched card standard.

Feng Nuo naturally strove to get the task of being responsible for this part. He had done a lot of research and was the representative of the Planning Commission, while those Elders in mechanics and electricity weren't very interested in this matter.

"Therefore, we must determine the punched card specifications from the beginning, unifying them at least in all civil applications. There are 45-column, 80-column, 90-column types of punched cards, but the most common, and also used in the earliest 1890 US census, is the 'Hollerith' punched card, later commonly known as the 'IBM card.' This card is made of durable card stock, printed with 10 rows x 80 columns of numbers, with numbers in each row being 0-9. In addition, there are two rows of punching positions, 11 and 12, on the card, but without printed marks. Row 11 is also called Row X, and Row 12 is also called Row Y. Their positions are actually located above the number rows. These two rows, plus Row 0, are collectively called the 'Zone Rows' or 'High Zone'."
...
Currently, the venue was silent. Participants were probably suspecting whether they could build equipment to read and punch such precise cards. Feng Nuo, however, was thinking that he forgot to invite people from the paper mill to participate in the discussion. Whether paper meeting the specifications could be produced right now was very doubtful. Climbing the tech tree, every step was a pit, a myriad of loose ends. But he was prepared and continued:

"This is the punched card standard released domestically in the late 70s. Its manufacturing precision was naturally established to meet the requirement of punched card computer systems processing 1000 to 2000 cards per minute at that time. We currently don't have early card standards for punched card computer systems, but it is certain that early 20th-century technology couldn't reach such precision standards. In fact, in a 50s document, the card dimensions were simply introduced as 18.6 cm x 8.3 cm. Therefore, punched card precision and error standards suitable for our self-made equipment remain to be further explored during development."
