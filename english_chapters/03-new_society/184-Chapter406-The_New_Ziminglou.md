...
The new design plan eliminated the large but useless backyard. Drawing inspiration from the "Fan Building" of the Northern Song Dynasty, Zhang Xingpei prepared to build a multi-building complex. There were three buildings in total, front and back, ranging from three to four stories, arranged in a staggered and orderly manner. The buildings were connected by two-story corridors. From a plan view, it looked largely like the character "田" (field). Each building was equipped with multiple staircases, and separate dedicated staircases and passages were set up for internal personnel like waiters.
