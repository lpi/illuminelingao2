# Chapter 249: Bopu Fortifications
...
"That's true, but there are still too few cannons. Bopu needs to be fortified." Ying Yu shook his head. As an artillery commander, he belonged to a cross-service branch; gunners from both the army and navy trained in his artillery company. He was responsible for the firepower arrangement of the Bopu fortification project. "Adding these two, there are only six cannons available for installation in the fortress area. What use is this?"

"Casting new cannons isn't hard, but we should standardize. Now it's too random, and the standards are a bit messy: some are marked by caliber and others by shot weight. Stockpiling ammunition is too difficult," Li Yunxing suggested.

"Of course, we should equip everyone with rifled cannons." Ying Yu looked down on smoothbore guns. "The Army can use imitated Japanese Type 92 Battalion Guns plus mortars. The Navy can use 70mm or 100mm breech-loading rifled cannons."
...
Everyone came down from the gun emplacement and returned to the fortress command post. The newly completed post was located at the top of the Bopu beacon tower hill, in the same place as the heavy artillery emplacement. This artificial hill, over 25 meters high with a 45-degree slope, was transformed into the main support point of the entire Bopu Fortifications. In addition to the original lookout posts and searchlights, many structures such as the command post, soldier barracks, and ammunition depots were added to it.

In order to transport numerous building materials and heavy cannons up to the beacon tower, the Construction Company excavated a winch slide on the hillside, using an electric winch to pull cargo buckets to the top, completely solving the transportation problem. Finally, this winch track was expanded into a covered concealed tunnel. In addition to transporting personnel and supplies, the telephone lines and power lines that were originally exposed to the open air and easily damaged were also moved inside the tunnel.
