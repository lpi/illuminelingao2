...
  复制少量卡片时，重迭新旧卡片对着光看看即可检查穿孔是否一致。1000张卡片却不能再用人工方法检验正确性了。因此，冯诺嘱咐他们复制好后用制表机检查穿孔是否一致。方法是分别统计两迭卡片每列的0-9的数量是否一致，如果结果相同，有问题的概率就可以忽略不计了。不过按当前制表机的速度，每列的检查时间大概在20分钟左右，80列需要20多个小时，只好让两人晚上轮班了。
...
  “工作态度可嘉，工作方法愚蠢。”冯诺评论道。他走过去拿起三人还没检查过的两迭卡片，问：“检查多少了？”
...
  “看看，三个人一上午才查了三百多张。以后我们要测试1万张卡片，得找多少人来？”说着他把手中的一迭卡片递给冯珊，说：“查出330张来。”

  然后他问钱羽之是哪一列出了错，调整了制表机的读卡电刷位置。又把自己手里剩余的一迭也分成330张和327张的两迭。

  随后，冯诺先后把冯珊查出来的的330张新卡和自己分出的330张旧卡用制表机统计了一遍。

  十几分钟后，统计结束了，结果是相同的。

  “所以，错卡肯定在另外一半里面了。”冯诺指了指剩余的两迭卡片。

  于是他从剩余的两迭327张卡片中，各分出了160张卡片，输入了制表机。这次结果显示错误的卡片就在这160张之中。
...
  冯诺点点头，“不一样，但思路是类似的。如果你稍微思考一下，昨天我为什么让羽之和加奈用制表机检查两迭1000张卡片是否一致，就能想到很多方案。最起码，你可以每次输入100张卡，最多10次，你们也就能知道错卡在哪个100张里面了。——当然，如果你能想到这个，也就能意识到二分查找是最快的。”
